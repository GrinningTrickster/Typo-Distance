# code taken in its entirety from: https://github.com/wsong/Typo-Distance/blob/master/typodistance.py
# Edits have been made to match a British QWERTY Keyboard.
